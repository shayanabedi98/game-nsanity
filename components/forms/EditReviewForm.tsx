...
export default function EditReviewForm({
  ...
  const [review, setReview] = useState<Review>({
    ...
    paragraphs: reviewData.paragraphs,
    rating: reviewData.rating,
    thumbnailUrl: {
      secure_url: reviewData.thumbnailUrl.secure_url,
      public_id: reviewData.thumbnailUrl.public_id,
    },
  ...
  return (
    <div className="flex flex-col items-center px-8 py-4 sm:w-96 w-full mx-auto justify-center bg-neutral-900 rounded-md shadow-lg">
      ...
      >
        <p className="text-xl font-semibold">Update Review</p>
